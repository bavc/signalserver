...
Create a directly where you want to mount the file volume for SignalServer. (default is `/files`)
So create `/files` directly if you don't have a strong preference about it.
